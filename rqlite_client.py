...
class RqliteClient:
    ...
    def is_leader_ready(self, timeout=20):
        ...
        while time.time() - start_time < timeout:
            try:
                ...
                if response.status_code == 200 and 'leader ok' in response.text:
                ...
                print(ex)
                time.sleep(1)  # Wait and retry in case of a request exception
