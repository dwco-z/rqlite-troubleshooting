...
if __name__ == '__main__':
    ...
    for i in range(100):
        try:
            ...
            node1Manager = RqliteManager(data_path="Node1", host='localhost', http_port=4001, raft_port=5001, log_file="node1.log", rqlited_path="rqlited.exe", raft_heartbeat_timeout=2, raft_election_timeout=10)
            node2Manager = RqliteManager(data_path="Node2", host='localhost', http_port=4002, raft_port=5002, log_file="node2.log", rqlited_path="rqlited.exe", raft_heartbeat_timeout=10, raft_election_timeout=20)
            node3Manager = RqliteManager(data_path="Node3", host='localhost', http_port=4003, raft_port=5003, log_file="node3.log", rqlited_path="rqlited.exe", raft_heartbeat_timeout=10, raft_election_timeout=20)
